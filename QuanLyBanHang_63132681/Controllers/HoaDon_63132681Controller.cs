...
{
    public class HoaDon_63132681Controller : Controller
    {
        ...
        {
            // If KhachHangID is null, retrieve all orders; otherwise, filter by KhachHangID
            var orders = id.HasValue
                ? db.HoaDons.Where(d => d.MaKhachHang == id)
                : db.HoaDons;
